...
interface TabKebiasaanProps {
  siswaList: SiswaPelengkapItem[];
  opsiKebiasaanList: string[];
  loadingId: string | null;
  isBulkSaving: boolean;
  onKebiasaanChange: (siswaId: string, text: string) => void;
  onOpenKebiasaanModal: (siswaId: string) => void;
  onBulkSaveKebiasaan: () => Promise<void>;
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {hasUnsavedChanges && (
            <button
              ...
              title="Batalkan seluruh perubahan kebiasaan yang belum disimpan"
            >
                  ...
                  <td className="py-3 px-4">
                    <div className="space-y-1.5">
                      ...
                      <div className="flex items-center justify-between">
                        <button
                          type="button"
                          onClick={() => onOpenKebiasaanModal(s.id)}
                    ...
                    <div className="flex items-center justify-center gap-1.5">
                      {!s.isKebiasaanSaved && (
                        <button
                          ...
                          title="Batalkan perubahan kebiasaan untuk siswa ini"
                        >
                          <RotateCcwIcon className="h-3.5 w-3.5" />
                          <span>Batal</span>
                        </button>
